...
"""Tests for HeightToNormalCommandLineTool."""
...
from pipescaler.scripts.processors import HeightToNormalCommandLineTool
from pipescaler.testing import get_infile


@fixture
def script(request) -> str:
    return getfile(HeightToNormalCommandLineTool)
